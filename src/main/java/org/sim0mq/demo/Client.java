 ...
 * <p>
 * (c) copyright 2015-2024 <a href="http://www.simulation.tudelft.nl">Delft
 * University of Technology</a>. <br>
 * BSD-style license. See
 * <a href="http://www.simulation.tudelft.nl/dsol/3.0/license.html">DSOL
 * License</a>. <br>
 * 
...
public final class Client {
	...
	public static void main(final String[] args) throws Sim0MQException, SerializationException {
		...
		// send a reply
		Object[] request = new Object[] { "test message", Double.valueOf(14.2), Float.valueOf(-28.4f),
				Short.valueOf((short) 10) };
		requester.send(Sim0MQMessage.encodeUTF8(true, "IDVV14.2", "MC.1", "MM1.4", "TEST.2", 1201L, request), 0);
